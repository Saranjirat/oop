...
@app.get("/register")
async def registor(fname : str, lname : str, email : str, password : str, phone : str):
    global m1
    for i in sym.list_user:
        if i._contact_name == fname:
            return 'already taken'
    m1 = User(fname, lname, phone, email, password)
    sym.add_user(m1)
    print(sym.list_user)
    return 'success'
